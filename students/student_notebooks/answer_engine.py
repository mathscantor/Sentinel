...
class AnswerEngine:
    ...
    def __init__(self):
        self.file_name = "answer_engine.py"
        self.answer_sha512_mapping = { 
            ...
            7: ["a3026a53cd4e955635b44072cb8d1c89ca56965271c9859a7ae1b5bf8b0b8c3dd92856f95e8d192da48a350b25170b1010afa84c5af21099ad0869d1c5b9bf8c", False],
    ...
    def get_engine_hashes(self) -> str:
        md5 = hashlib.md5()
        sha1 = hashlib.sha1()
        ...
        return "MD5: {}\nSHA1: {}\nSHA512: {}\n".format(md5.hexdigest(), sha1.hexdigest(), sha512.hexdigest())
